...
function addpoints()
{
    ...
    document.getElementById("userscore").innerHTML = "Ounces of Water " + score ;
    
    if (score == 2) {
        console.log("You Passed the first level!");
        level=2;
        game.system.setScene('Main');
    }
    
    if (score == 4) {
        console.log("You Passed the second level!");
        level=3;
        game.system.setScene('Main');
    }
    
    if (score == 6) {
        console.log("You Passed the third level!");
        level=4;
        game.system.setScene('Main');
    }
    
    if (score == 8) {
        console.log("You Passed the fourth level!");
        level=5;
        game.system.setScene('Main');
    }
    
    if (score == 10) {
        console.log("You Passed the fifth level!");
        level=6;
        game.system.setScene('Main');
    }
    
    if (score == 12) {
        console.log("You Passed the Final level!");
        level=1;
        game.system.setScene('Main');
        window.alert("WOW YOU PASSED THE GAME?\nAs a token of your achievemnent, Would You like to Donate towards the cause of providing Flint, Michigan with the help it needs?");
        setTimeout(function(){ window.location= "http://www.helpforflint.com/action/"; }, 45000);
...
game.createClass('Coin', {
    ...
    update: function() {
        ...
        if (this.body.position.x + this.sprite.width / 2 < 0)
        this.remove()
